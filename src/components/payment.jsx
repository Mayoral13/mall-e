...
const Payment = ()=>{
  ...
  <div className="mb-5 text-gray-400">
    ...
    /{' '}
    <Link to="/cart" className="focus:outline-none hover:underline text-gray-500">
      Cart
    </Link>{' '}
                  ...
                  <div className="w-full mx-auto text-gray-800 font-light mb-6 border-b border-gray-200 pb-6">
                    <div className="w-full flex items-center">
                      ...
                      <div className="flex-grow pl-3">
                        <h6 className="font-semibold uppercase text-gray-600">Basic Tee</h6>
                        <p className="text-gray-400">x 1</p>
                      </div>
                      <div>
                        <span className="font-semibold text-gray-600 text-xl">$35</span>
                    ...
                    <div className="w-full p-3 border-b border-gray-200">
                      <div className="mb-5">
                        <label htmlFor="type1" className="flex items-center cursor-pointer">
                          ...
                          <img src="https://leadershipmemphis.org/wp-content/uploads/2020/08/780370.png" className="h-6 ml-3" alt="Credit Card" />
                        </label>
                      </div>
                      <div>
                        <div className="mb-3">
